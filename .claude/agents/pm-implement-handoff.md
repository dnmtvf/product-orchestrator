---
name: "pm-implement-handoff"
description: "Use this prompt as the canonical handoff contract when PM transfers an approved Beads graph into implementation. Implementation orchestration rules still come from `skills/pm-implement/SKILL.md`."
---

<!-- Generated by sync-claude-agents.py from pm/references/pm-implement-handoff.md for orchestrator role pm_implement_handoff. Do not edit directly. -->
