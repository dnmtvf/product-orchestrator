use agent swarm for PM self-check healer: investigate run self-check-20260320T075955Z-9ab16cfec9 for fixture happy-path and use the normal PM flow to package any orchestrator repairs.
...
Run ID: self-check-20260320T075955Z-9ab16cfec9
Fixture case: happy-path
Synthetic task: Create a snake game
Summary file: .codex/self-check-runs/self-check-20260320T075955Z-9ab16cfec9/summary.json
Healer context file: .codex/self-check-runs/self-check-20260320T075955Z-9ab16cfec9/healer-context.json

Summary JSON:
{
  "run_id": "self-check-20260320T075955Z-9ab16cfec9",
  "fixture_suite_version": "pm-self-check-v1",
  "fixture_case": "happy-path",
  "execution_mode": "main-runtime-only",
  "artifact_dir": ".codex/self-check-runs/self-check-20260320T075955Z-9ab16cfec9",
  "synthetic_task": "Create a snake game",
  "status": "clean",
  "started_at": "2026-03-20T07:59:55Z",
  "completed_at": "2026-03-20T08:00:09Z",
  "claude_health": {
    "registration": "passed",
  ...
  "child_plan_gate": {
    "status": "ready",
    "output_file": ".codex/self-check-runs/self-check-20260320T075955Z-9ab16cfec9/child-plan-gate.txt"
  },
  "healer_prompt_file": ".codex/self-check-runs/self-check-20260320T075955Z-9ab16cfec9/healer-prompt.md",
  "healer_context_file": ".codex/self-check-runs/self-check-20260320T075955Z-9ab16cfec9/healer-context.json",
  "events": [
    {
      "run_id": "self-check-20260320T075955Z-9ab16cfec9",
      "phase": "artifacts",
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260320T075955Z-9ab16cfec9/claude-mcp-list.txt",
      "created_at": "2026-03-20T08:00:03Z"
    },
    {
      "run_id": "self-check-20260320T075955Z-9ab16cfec9",
      "phase": "health",
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260320T075955Z-9ab16cfec9/codex-mcp-list.txt",
      "created_at": "2026-03-20T08:00:06Z"
    },
    {
      "run_id": "self-check-20260320T075955Z-9ab16cfec9",
      "phase": "health",
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260320T075955Z-9ab16cfec9/codex-mcp-list.txt",
      "created_at": "2026-03-20T08:00:08Z"
    },
    {
      "run_id": "self-check-20260320T075955Z-9ab16cfec9",
      "phase": "health",
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260320T075955Z-9ab16cfec9/claude-session-probe-eval.txt",
      "created_at": "2026-03-20T08:00:09Z"
    },
    {
      "run_id": "self-check-20260320T075955Z-9ab16cfec9",
      "phase": "child_flow",
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260320T075955Z-9ab16cfec9/child-plan-gate.txt",
      "created_at": "2026-03-20T08:00:09Z"
    },
    {
      "run_id": "self-check-20260320T075955Z-9ab16cfec9",
