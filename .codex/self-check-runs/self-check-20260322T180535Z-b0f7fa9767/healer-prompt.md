use agent swarm for PM self-check healer: investigate run self-check-20260322T180535Z-b0f7fa9767 for fixture happy-path and use the normal PM flow to package any orchestrator repairs.
...
Run ID: self-check-20260322T180535Z-b0f7fa9767
Fixture case: happy-path
Synthetic task: Create a snake game
Summary file: .codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/summary.json
Healer context file: .codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/healer-context.json

Summary JSON:
{
  "run_id": "self-check-20260322T180535Z-b0f7fa9767",
  "fixture_suite_version": "pm-self-check-v1",
  "fixture_case": "happy-path",
  "execution_mode": "main-runtime-only",
  "artifact_dir": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767",
  "synthetic_task": "Create a snake game",
  "status": "clean",
  "started_at": "2026-03-22T18:05:35Z",
  "completed_at": "2026-03-22T18:05:47Z",
  "claude_health": {
    "registration": "passed",
  ...
  "child_plan_gate": {
    "status": "ready",
    "output_file": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/child-plan-gate.txt"
  },
  "artifact_checks": {
    "codex_mcp_snapshot": {
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/codex-mcp-list.txt",
      "stdout_path": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/codex-mcp-list.stdout.txt",
      "stderr_path": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/codex-mcp-list.stderr.txt",
      "attempt_file": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/codex-mcp-list.attempt.json",
      "started_at": "2026-03-22T18:05:35Z",
      "completed_at": "2026-03-22T18:05:37Z",
      "elapsed_ms": 2000,
      "exit_code": 0,
      "exit_signal": null,
      "timed_out": false,
      "pid": "65266",
      "process_state": "65266 65205 S    node /opt/homebrew/bin/codex mcp list",
      "timeout_seconds": 5,
    ...
    "claude_mcp_snapshot": {
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/claude-mcp-list.txt",
      "stdout_path": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/claude-mcp-list.stdout.txt",
      "stderr_path": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/claude-mcp-list.stderr.txt",
      "attempt_file": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/claude-mcp-list.attempt.json",
      "started_at": "2026-03-22T18:05:39Z",
      "completed_at": "2026-03-22T18:05:44Z",
      "elapsed_ms": 5000,
      "exit_code": 0,
      "exit_signal": null,
      "timed_out": false,
      "pid": "65423",
      "process_state": "65423 65205 S    /Users/d/.local/bin/claude mcp list",
      "timeout_seconds": 12,
  ...
  "healer_prompt_file": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/healer-prompt.md",
  "healer_context_file": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/healer-context.json",
  "events": [
    {
      "run_id": "self-check-20260322T180535Z-b0f7fa9767",
      "phase": "artifacts",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:05:37Z"
    },
    {
      "run_id": "self-check-20260322T180535Z-b0f7fa9767",
      "phase": "artifacts",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/claude-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:05:44Z"
    },
    {
      "run_id": "self-check-20260322T180535Z-b0f7fa9767",
      "phase": "artifacts",
    ...
    },
    {
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:05:45Z"
    },
    {
      "run_id": "self-check-20260322T180535Z-b0f7fa9767",
      "phase": "health",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:05:47Z"
    },
    {
      "run_id": "self-check-20260322T180535Z-b0f7fa9767",
      "phase": "health",
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/claude-session-probe-eval.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:05:47Z"
    },
    {
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180535Z-b0f7fa9767/child-plan-gate.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:05:47Z"
    },
    {
