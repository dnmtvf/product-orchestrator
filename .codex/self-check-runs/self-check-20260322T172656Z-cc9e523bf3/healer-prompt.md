use agent swarm for PM self-check healer: investigate run self-check-20260322T172656Z-cc9e523bf3 for fixture happy-path and use the normal PM flow to package any orchestrator repairs.
...
Run ID: self-check-20260322T172656Z-cc9e523bf3
Fixture case: happy-path
Synthetic task: Create a snake game
Summary file: .codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/summary.json
Healer context file: .codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/healer-context.json

Summary JSON:
{
  "run_id": "self-check-20260322T172656Z-cc9e523bf3",
  "fixture_suite_version": "pm-self-check-v1",
  "fixture_case": "happy-path",
  "execution_mode": "main-runtime-only",
  "artifact_dir": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3",
  "synthetic_task": "Create a snake game",
  "status": "issues_detected",
  "started_at": "2026-03-22T17:26:56Z",
  "completed_at": "2026-03-22T17:27:09Z",
  "claude_health": {
    "registration": "passed",
  ...
  "child_plan_gate": {
    "status": "ready",
    "output_file": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/child-plan-gate.txt"
  },
  "artifact_checks": {
    "codex_mcp_snapshot": {
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/codex-mcp-list.txt",
      "stdout_path": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/codex-mcp-list.stdout.txt",
      "stderr_path": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/codex-mcp-list.stderr.txt",
      "attempt_file": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/codex-mcp-list.attempt.json",
      "started_at": "2026-03-22T17:26:56Z",
      "completed_at": "2026-03-22T17:26:58Z",
      "elapsed_ms": 2000,
      "exit_code": 0,
      "exit_signal": null,
      "timed_out": false,
      "pid": "41479",
      "process_state": "41479 41422 S    node /opt/homebrew/bin/codex mcp list",
    ...
    "claude_mcp_snapshot": {
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/claude-mcp-list.txt",
      "stdout_path": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/claude-mcp-list.stdout.txt",
      "stderr_path": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/claude-mcp-list.stderr.txt",
      "attempt_file": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/claude-mcp-list.attempt.json",
      "started_at": "2026-03-22T17:27:00Z",
      "completed_at": "2026-03-22T17:27:06Z",
      "elapsed_ms": 6000,
      "exit_code": null,
      "exit_signal": "TERM",
      "timed_out": true,
      "pid": "41627",
      "process_state": "41627 41422 S    /Users/d/.local/bin/claude mcp list",
  ...
  "healer_prompt_file": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/healer-prompt.md",
  "healer_context_file": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/healer-context.json",
  "events": [
    {
      "run_id": "self-check-20260322T172656Z-cc9e523bf3",
      "phase": "artifacts",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T17:26:58Z"
    },
    {
      "run_id": "self-check-20260322T172656Z-cc9e523bf3",
      "phase": "artifacts",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/claude-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T17:27:06Z"
    },
    {
      "run_id": "self-check-20260322T172656Z-cc9e523bf3",
      "phase": "health",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T17:27:07Z"
    },
    {
      "run_id": "self-check-20260322T172656Z-cc9e523bf3",
      "phase": "health",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T17:27:09Z"
    },
    {
      "run_id": "self-check-20260322T172656Z-cc9e523bf3",
      "phase": "health",
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/claude-session-probe-eval.txt",
      "metadata": {},
      "created_at": "2026-03-22T17:27:09Z"
    },
    {
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172656Z-cc9e523bf3/child-plan-gate.txt",
      "metadata": {},
      "created_at": "2026-03-22T17:27:09Z"
    },
    {
