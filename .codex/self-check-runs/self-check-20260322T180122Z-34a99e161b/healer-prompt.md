use agent swarm for PM self-check healer: investigate run self-check-20260322T180122Z-34a99e161b for fixture happy-path and use the normal PM flow to package any orchestrator repairs.
...
Run ID: self-check-20260322T180122Z-34a99e161b
Fixture case: happy-path
Synthetic task: Create a snake game
Summary file: .codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/summary.json
Healer context file: .codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/healer-context.json

Summary JSON:
{
  "run_id": "self-check-20260322T180122Z-34a99e161b",
  "fixture_suite_version": "pm-self-check-v1",
  "fixture_case": "happy-path",
  "execution_mode": "main-runtime-only",
  "artifact_dir": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b",
  "synthetic_task": "Create a snake game",
  "status": "clean",
  "started_at": "2026-03-22T18:01:22Z",
  "completed_at": "2026-03-22T18:01:37Z",
  "claude_health": {
    "registration": "passed",
  ...
  "child_plan_gate": {
    "status": "ready",
    "output_file": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/child-plan-gate.txt"
  },
  "artifact_checks": {
    "codex_mcp_snapshot": {
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/codex-mcp-list.txt",
      "stdout_path": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/codex-mcp-list.stdout.txt",
      "stderr_path": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/codex-mcp-list.stderr.txt",
      "attempt_file": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/codex-mcp-list.attempt.json",
      "started_at": "2026-03-22T18:01:22Z",
      "completed_at": "2026-03-22T18:01:24Z",
      "elapsed_ms": 2000,
      "exit_code": 0,
      "exit_signal": null,
      "timed_out": false,
      "pid": "61033",
      "process_state": "61033 60971 S    node /opt/homebrew/bin/codex mcp list",
      "timeout_seconds": 5,
    ...
    "claude_mcp_snapshot": {
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/claude-mcp-list.txt",
      "stdout_path": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/claude-mcp-list.stdout.txt",
      "stderr_path": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/claude-mcp-list.stderr.txt",
      "attempt_file": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/claude-mcp-list.attempt.json",
      "started_at": "2026-03-22T18:01:25Z",
      "completed_at": "2026-03-22T18:01:33Z",
      "elapsed_ms": 8000,
      "exit_code": 0,
      "exit_signal": null,
      "timed_out": false,
      "pid": "61199",
      "process_state": "61199 60971 S    /Users/d/.local/bin/claude mcp list",
      "timeout_seconds": 12,
  ...
  "healer_prompt_file": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/healer-prompt.md",
  "healer_context_file": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/healer-context.json",
  "events": [
    {
      "run_id": "self-check-20260322T180122Z-34a99e161b",
      "phase": "artifacts",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:01:24Z"
    },
    {
      "run_id": "self-check-20260322T180122Z-34a99e161b",
      "phase": "artifacts",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/claude-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:01:34Z"
    },
    {
      "run_id": "self-check-20260322T180122Z-34a99e161b",
      "phase": "artifacts",
    ...
    },
    {
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:01:35Z"
    },
    {
      "run_id": "self-check-20260322T180122Z-34a99e161b",
      "phase": "health",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:01:36Z"
    },
    {
      "run_id": "self-check-20260322T180122Z-34a99e161b",
      "phase": "health",
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/claude-session-probe-eval.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:01:36Z"
    },
    {
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180122Z-34a99e161b/child-plan-gate.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:01:37Z"
    },
    {
      "run_id": "self-check-20260322T180122Z-34a99e161b",
      "phase": "fixture",
