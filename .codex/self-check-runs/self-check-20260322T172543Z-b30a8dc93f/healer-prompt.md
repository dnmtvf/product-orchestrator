use agent swarm for PM self-check healer: investigate run self-check-20260322T172543Z-b30a8dc93f for fixture happy-path and use the normal PM flow to package any orchestrator repairs.
...
Run ID: self-check-20260322T172543Z-b30a8dc93f
Fixture case: happy-path
Synthetic task: Create a snake game
Summary file: .codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/summary.json
Healer context file: .codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/healer-context.json

Summary JSON:
{
  "run_id": "self-check-20260322T172543Z-b30a8dc93f",
  "fixture_suite_version": "pm-self-check-v1",
  "fixture_case": "happy-path",
  "execution_mode": "main-runtime-only",
  "artifact_dir": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f",
  "synthetic_task": "Create a snake game",
  "status": "issues_detected",
  "started_at": "2026-03-22T17:25:43Z",
  "completed_at": "2026-03-22T17:25:56Z",
  "claude_health": {
    "registration": "passed",
  ...
  "child_plan_gate": {
    "status": "ready",
    "output_file": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/child-plan-gate.txt"
  },
  "artifact_checks": {
    "codex_mcp_snapshot": {
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/codex-mcp-list.txt",
      "stdout_path": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/codex-mcp-list.stdout.txt",
      "stderr_path": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/codex-mcp-list.stderr.txt",
      "attempt_file": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/codex-mcp-list.attempt.json",
      "started_at": "2026-03-22T17:25:43Z",
      "completed_at": "2026-03-22T17:25:45Z",
      "elapsed_ms": 2000,
      "exit_code": 0,
      "exit_signal": null,
      "timed_out": false,
      "pid": "39862",
      "process_state": "39862 39750 S    node /opt/homebrew/bin/codex mcp list",
    ...
    "claude_mcp_snapshot": {
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/claude-mcp-list.txt",
      "stdout_path": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/claude-mcp-list.stdout.txt",
      "stderr_path": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/claude-mcp-list.stderr.txt",
      "attempt_file": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/claude-mcp-list.attempt.json",
      "started_at": "2026-03-22T17:25:46Z",
      "completed_at": "2026-03-22T17:25:52Z",
      "elapsed_ms": 6000,
      "exit_code": null,
      "exit_signal": "TERM",
      "timed_out": true,
      "pid": "40179",
      "process_state": "40179 39750 S    /Users/d/.local/bin/claude mcp list",
  ...
  "healer_prompt_file": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/healer-prompt.md",
  "healer_context_file": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/healer-context.json",
  "events": [
    {
      "run_id": "self-check-20260322T172543Z-b30a8dc93f",
      "phase": "artifacts",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T17:25:45Z"
    },
    {
      "run_id": "self-check-20260322T172543Z-b30a8dc93f",
      "phase": "artifacts",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/claude-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T17:25:52Z"
    },
    {
      "run_id": "self-check-20260322T172543Z-b30a8dc93f",
      "phase": "health",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T17:25:54Z"
    },
    {
      "run_id": "self-check-20260322T172543Z-b30a8dc93f",
      "phase": "health",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T17:25:55Z"
    },
    {
      "run_id": "self-check-20260322T172543Z-b30a8dc93f",
      "phase": "health",
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/claude-session-probe-eval.txt",
      "metadata": {},
      "created_at": "2026-03-22T17:25:55Z"
    },
    {
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260322T172543Z-b30a8dc93f/child-plan-gate.txt",
      "metadata": {},
      "created_at": "2026-03-22T17:25:56Z"
    },
    {
      "run_id": "self-check-20260322T172543Z-b30a8dc93f",
      "phase": "fixture",
