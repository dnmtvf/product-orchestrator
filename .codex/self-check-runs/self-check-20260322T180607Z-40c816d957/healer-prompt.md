use agent swarm for PM self-check healer: investigate run self-check-20260322T180607Z-40c816d957 for fixture happy-path and use the normal PM flow to package any orchestrator repairs.
...
Run ID: self-check-20260322T180607Z-40c816d957
Fixture case: happy-path
Synthetic task: Create a snake game
Summary file: .codex/self-check-runs/self-check-20260322T180607Z-40c816d957/summary.json
Healer context file: .codex/self-check-runs/self-check-20260322T180607Z-40c816d957/healer-context.json

Summary JSON:
{
  "run_id": "self-check-20260322T180607Z-40c816d957",
  "fixture_suite_version": "pm-self-check-v1",
  "fixture_case": "happy-path",
  "execution_mode": "main-runtime-only",
  "artifact_dir": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957",
  "synthetic_task": "Create a snake game",
  "status": "clean",
  "started_at": "2026-03-22T18:06:07Z",
  "completed_at": "2026-03-22T18:06:19Z",
  "claude_health": {
    "registration": "passed",
  ...
  "child_plan_gate": {
    "status": "ready",
    "output_file": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/child-plan-gate.txt"
  },
  "artifact_checks": {
    "codex_mcp_snapshot": {
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/codex-mcp-list.txt",
      "stdout_path": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/codex-mcp-list.stdout.txt",
      "stderr_path": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/codex-mcp-list.stderr.txt",
      "attempt_file": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/codex-mcp-list.attempt.json",
      "started_at": "2026-03-22T18:06:07Z",
      "completed_at": "2026-03-22T18:06:09Z",
      "elapsed_ms": 2000,
      "exit_code": 0,
      "exit_signal": null,
      "timed_out": false,
      "pid": "66364",
      "process_state": "66364 66303 S    node /opt/homebrew/bin/codex mcp list",
      "timeout_seconds": 5,
    ...
    "claude_mcp_snapshot": {
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/claude-mcp-list.txt",
      "stdout_path": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/claude-mcp-list.stdout.txt",
      "stderr_path": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/claude-mcp-list.stderr.txt",
      "attempt_file": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/claude-mcp-list.attempt.json",
      "started_at": "2026-03-22T18:06:11Z",
      "completed_at": "2026-03-22T18:06:16Z",
      "elapsed_ms": 5000,
      "exit_code": 0,
      "exit_signal": null,
      "timed_out": false,
      "pid": "66648",
      "process_state": "66648 66303 S    /Users/d/.local/bin/claude mcp list",
      "timeout_seconds": 12,
  ...
  "healer_prompt_file": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/healer-prompt.md",
  "healer_context_file": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/healer-context.json",
  "events": [
    {
      "run_id": "self-check-20260322T180607Z-40c816d957",
      "phase": "artifacts",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:06:10Z"
    },
    {
      "run_id": "self-check-20260322T180607Z-40c816d957",
      "phase": "artifacts",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/claude-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:06:16Z"
    },
    {
      "run_id": "self-check-20260322T180607Z-40c816d957",
      "phase": "artifacts",
    ...
    },
    {
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:06:17Z"
    },
    {
      "run_id": "self-check-20260322T180607Z-40c816d957",
      "phase": "health",
      ...
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/codex-mcp-list.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:06:19Z"
    },
    {
      "run_id": "self-check-20260322T180607Z-40c816d957",
      "phase": "health",
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/claude-session-probe-eval.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:06:19Z"
    },
    {
      ...
      "remediation": "",
      "artifact_path": ".codex/self-check-runs/self-check-20260322T180607Z-40c816d957/child-plan-gate.txt",
      "metadata": {},
      "created_at": "2026-03-22T18:06:19Z"
    },
    {
