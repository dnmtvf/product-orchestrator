...
assert_file "$INJECT_TARGET/.codex/skills/pm/scripts/claude-code-mcp"
assert_file "$INJECT_TARGET/.claude/skills/pm/scripts/claude-code-mcp"
assert_file "$INJECT_TARGET/.codex/skills/pm/scripts/sync-claude-agents.py"
assert_file "$INJECT_TARGET/.claude/skills/pm/scripts/sync-claude-agents.py"
...
assert_file "$INJECT_TARGET/.claude/agents/pm-project-manager.md"
assert_file "$INJECT_TARGET/.claude/agents/pm-jazz-reviewer.md"
...
jq -e '.managed_claude_agents_dir == ".claude/agents"' "$INJECT_TARGET/.orchestrator-injected.json" >/dev/null || fail "inject manifest should record managed Claude agents dir"
...
assert_file "$INSTALL_TARGET/.codex/skills/pm/scripts/claude-code-mcp"
assert_file "$INSTALL_TARGET/.claude/skills/pm/scripts/claude-code-mcp"
assert_file "$INSTALL_TARGET/.codex/skills/pm/scripts/sync-claude-agents.py"
assert_file "$INSTALL_TARGET/.claude/skills/pm/scripts/sync-claude-agents.py"
...
assert_file "$INSTALL_TARGET/.claude/agents/pm-project-manager.md"
assert_file "$INSTALL_TARGET/.claude/agents/pm-jazz-reviewer.md"
